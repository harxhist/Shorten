      ...
      <div className="bg-[#282828] py-0 px-4 md:px-6">
        <div className="max-w-screen-lg mx-auto flex flex-col md:flex-row items-center md:space-x-12">
          ...
          <div className="w-1/2 hidden md:block">
            <Image src={ios} alt="shorten preview" width={500} height={500} />
          </div>
          ...
          <div className="pb-8 text-center md:text-left">
            ...
            <Link 
              href="https://www.icloud.com/shortcuts/f7534d2395214947af199a878ded7acc" 
              target="_blank" 
              rel="noopener noreferrer"
              className="mt-12 inline-flex items-center py-1.5 px-4 rounded-xl space-x-2 text-white hover:shadow-lg bg-[#1D1F57]"
            >
              <Image src={shortcut} alt="iOS Shortcut Icon" width={60} height={60} />
              <div className="px-2">
          ...
          <div className="md:hidden text-white px-12 mt-8 md:mt-0">
            <Image src={ios} alt="shorten preview mobile" width={500} height={500} />
          </div>
        </div>
      </div>
